...
var friends = ["Abeeha", "Safia", "Sumaira"];
...
var myFriends = ["Abeeha", "Safia", "Sumaira"];
for (var _a = 0, myFriends_1 = myFriends; _a < myFriends_1.length; _a++) {
    var myfriend = myFriends_1[_a];
    console.log("Hello ".concat(myfriend, ", would you like to learn some TypeScript today?"));
}
//                         XXXXXXXXXXXXXXX
